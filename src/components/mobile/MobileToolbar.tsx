        ...
        <Card className="rounded-none border-x-0 border-b-0 bg-card/95 backdrop-blur-sm">
          ...
          <div className="flex items-center justify-around px-1 py-2 gap-0 min-[400px]:px-2 min-[400px]:gap-1">
            ...
            <Button
              ...
              size="icon"
              className={`h-11 w-11 relative ${landmarksGlow && !showMenu ? 'ring-2 ring-amber-400/80 animate-pulse' : ''}`}
              ...
              <div className="p-3 border-b border-border flex-shrink-0">
                ...
                <div className="grid grid-cols-4 gap-2">
                  ...
                  {state.mapId === 'varanasi' && (
                    <Button
                      variant={overlayMode === 'ganga' ? 'default' : 'ghost'}
                      size="sm"
                      className={`h-11 w-full text-xs ${overlayMode === 'ganga' ? 'bg-cyan-600 hover:bg-cyan-700' : ''}`}
