      ...
      <TooltipProvider>
        <div className="w-full h-full overflow-hidden bg-background flex flex-col">
          ...
          <div className="flex-1 relative overflow-hidden" style={{ paddingTop: '72px', paddingBottom: '76px' }}>
            ...
            />
            <FestivalEventBanner state={state} onOpen={setEventPanel} className="absolute bottom-[84px] left-3 z-20" />
      ...
      <div className="w-full h-full min-h-[720px] overflow-hidden bg-background flex">
        ...
        <div className="flex-1 flex flex-col ml-56">
          ...
          <div className="flex-1 relative overflow-visible">
            ...
            />
            <FestivalEventBanner state={state} onOpen={setEventPanel} className="absolute bottom-3 left-1/2 -translate-x-1/2 z-20" />
            <FestivalEventPanel festivalId={eventPanel} state={state} onClose={closeEventPanel} onLocate={locateEventArea} />
            {showOverlayPanel && (
